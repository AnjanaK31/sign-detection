...
def generate_actual_dataset_report():
    ...
    output_html  = "evaluation_report_finetuned.html"
    ...
    print("─── Running Evaluation on All Test Images ───")
...
<head>
  ...
  <title>OCR Evaluation Report – All Test Images</title>
...
<div class="header">
  ...
  <p>All test images (real + synthetic) · model: <code>best_model.pth</code></p>
</div>
...
<div class="footer">Generated by generate_actual_dataset_report.py · blueprint_ocr CRNN model · fine-tuned</div>
